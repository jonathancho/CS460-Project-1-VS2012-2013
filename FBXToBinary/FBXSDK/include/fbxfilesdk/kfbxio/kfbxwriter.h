...
class KFbxObject;
 ...
 /** This class provides the interface for writting files. It is the basis for the other FBX writers.
      * \nosubgrouping
      */
...
public:
	...
	/** Pre-processes the scene.
      * \param pScene The scene needs to be pre-prosessed.
      */
	...
	/** Sets the resampling rate as specifieds.
