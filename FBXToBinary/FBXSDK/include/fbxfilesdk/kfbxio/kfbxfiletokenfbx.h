...
#define FIELD_KFBXLAYER_ELEMENT_DISPLACEMENT_TEXTURES              "LayerElementDisplacementTextures"
...
#define FIELD_KFBXLAYER_ELEMENT_DISPLACEMENT_UV                "LayerElementDisplacementUV"
