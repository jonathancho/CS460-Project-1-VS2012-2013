...
namespace FBXPROCESSORS_NAMESPACE {
    ...
    */
    ...
    public:
        ...
        /**
        * Map the object to the property's hiearchical name.
    ...
    public:
        ...
        * The property filter is a list of strings, property names, which are automatically igonred when
        * encountered. Property names must be the full hiearchical property name (ie: parent|child|child).
        *
