...
public:
    ...
    */
	...
	/** Get the displacement color property. This property is used to make a
	 * surface more or less displacement.
	 */
	KFbxPropertyDouble3 GetDisplacementColor() const;
	
	/** Get the displacement property. This property is used to make a
