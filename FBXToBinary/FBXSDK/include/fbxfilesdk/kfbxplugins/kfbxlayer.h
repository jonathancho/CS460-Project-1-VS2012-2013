...
/** \brief Identify what error occurred when manipulating the data arrays.
  * \nosubgrouping
  */
...
{
public:
	/** \enum ELockAccessStatus	Identify what error occurred when manipulating the data arrays.
...
/** \brief Layer to map Binormals on a geometry.
  * \nosubgrouping
  */
...
/** \brief Layer to map Tangents on a geometry.
  * \nosubgrouping
  */
...
/** Layer to indicate crease of components of a geometry.
  * \nosubgrouping
  */
...
public:
    ...
    /** Get the Tagents description for this layer.
      * \return      Pointer to the Tagents layer element, or \c NULL if no Tagents are defined for this layer.
      * \remarks     A geometry of type KFbxNurb or KFbxPatch should not have Tagents defined.
      */
    ...
    /** Get the Binormals description for this layer.
      * \return      Pointer to the Binormals layer element, or \c NULL if no Binormals are defined for this layer.
      * \remarks     A geometry of type KFbxNurb or KFbxPatch should not have Binormals defined.
      */
    ...
    /** Get the DisplacementUV description for this layer.
	  ...
	  */
	KFbxLayerElementUV* GetDisplacementUV();

	/** Get the DisplacementUV description for this layer.
	  * \return     Pointer to the DisplacementUV layer element, or \c NULL if no DisplacementUV are defined for this layer.
	  */
	KFbxLayerElementUV const* GetDisplacementUV() const;
	...
	/** Get the Crease description for this layer.
	  * \return      Pointer to the Crease layer element, or \c NULL if no Crease is defined for this layer.
	  * \remarks     Crease info should defined when the geometry is KFbxSubdiv only.
	  */
    ...
    */
    ...
    /** Get the DisplacementTextures description for this layer.
	  ...
	  */
	KFbxLayerElementTexture* GetDisplacementTextures();

	/** Get the DisplacementTextures description for this layer.
	  * \return     Pointer to the DisplacementTextures layer element, or \c NULL if no DisplacementTextures are defined for this layer.
	  */
	KFbxLayerElementTexture const* GetDisplacementTextures() const;
	...
	/** Get the layer element description of the specified type for this layer.
      ...
      *                       - Calling with eBINORMAL is equivalent to calling GetBinormals().
      *                       - Calling with eTANGENT is equivalent to calling GetTangents().
	...
	/** Get the layer element description of the specified type for this layer.
	  ...
	  *                       - Calling with eVERTEX_COLOR is equivalent to calling GetVertexColors().
	  *                       - Calling with eSMOOTHING is equivalent to calling GetSmoothing().
      *                       - Calling with eCREASE is equivalent to calling GetVertexCrease().
	  *                       - Calling with eUSER_DATA is equivalent to calling GetUserData().
      *                       - Calling with eEMISSIVE_TEXTURES is equivalent to calling GetEmissiveTextures().
      *                       - Calling with eEMISSIVE_FACTOR_TEXTURES is equivalent to calling GetEmissiveFactorTextures().
      *                       - Calling with eAMBIENT_TEXTURES is equivalent to calling GetAmbientTextures().
      ...
      *                       - Calling with eREFLECTION_TEXTURES is equivalent to calling GetReflectionTextures().
      *                       - Calling with eREFLECTION_FACTOR_TEXTURES is equivalent to calling GetReflectionFactorTextures().
      *                       - Calling with eDISPLACEMENT_TEXTURES is equivalent to calling GetDisplacementTextures().
      * \param pIsUV     When \c true, request the UV LayerElement corresponding to the specified Layer Element type.
	  * \return          Pointer to the requested layer element, or \e NULL if the layer element is not defined for this layer.
	  */
    ...
    /** Set the Binormals description for this layer.
      * \param pBinormals     Pointer to the Binormals layer element, or \c NULL to remove the Binormals definition.
      * \remarks            A geometry of type KFbxNurb or KFbxPatch should not have Binormals defined.
      */
    void SetBinormals(KFbxLayerElementBinormal* pBinormals);

    /** Set the Tangents description for this layer.
      * \param pTangents     Pointer to the Tangents layer element, or \c NULL to remove the Tangents definition.
      * \remarks            A geometry of type KFbxNurb or KFbxPatch should not have Tangents defined.
      */
	...
	/** Set the Crease description for this layer.
	  * \param pCrease     Pointer to the Crease layer element, or \c NULL to remove the Crease definition.
	  * \remarks           Crease info should defined when the geometry is KFbxSubdiv only.
	  */
	...
	/** Set the DisplacementTextures description for this layer.
	  * \param pTextures     Pointer to the Textures layer element, or \c NULL to remove the Texture definition.
	  */
    void SetDisplacementTextures(KFbxLayerElementTexture* pTextures);
...
private:
    ...
    KFbxLayerElementTangent*      mTangents;
    KFbxLayerElementBinormal*     mBinormals;
    ...
    KFbxLayerElementCrease*       mVertexCrease;
    KFbxLayerElementCrease*       mEdgeCrease;
    ...
    KFbxLayerElementUV*      mDisplacementUV;
    ...
    KFbxLayerElementTexture*      mDisplacementTextures;
