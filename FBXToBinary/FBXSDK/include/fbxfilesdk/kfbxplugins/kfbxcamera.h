...
public:
    ...
    typedef ECameraPlateDrawingMode ECameraBackgroundDrawingMode K_DEPRECATED;
#else
    K_DEPRECATED typedef ECameraPlateDrawingMode ECameraBackgroundDrawingMode;
#endif
    ...
    /** \enum ECameraBackgroundPlacementOptions Back plate placement options.
	  * This enum is deprecated and has been replaced by the individual properties:
	  *     FitImage, Center, KeepRatio and Crop
      * - \e eFIT
      * - \e eCENTER
      * - \e eKEEP_RATIO
      * - \e eCROP
      */
    K_DEPRECATED typedef enum
    {
        eFIT = 1<<0,
        eCENTER = 1<<1,
        eKEEP_RATIO = 1<<2,
    ...
    /** Get background placement options.
	  ...
	  * \remarks    This method is deprecated since the different flags are now stored in the individual 
	  *             properties and can be accessed with the corresponding accessor methods.
      */
    K_DEPRECATED kUInt GetBackgroundPlacementOptions() const;
	...
	K_DEPRECATED typedef ECameraFrontBackPlaneDistanceMode ECameraBackPlaneDistanceMode;
	...
	K_DEPRECATED typedef ECameraFrontBackPlaneDisplayMode ECameraBackgroundDisplayMode;
	...
	/** Use the SetViewNearFarPlanes 
      * \param pEnable State of the ViewFrustum
      */
    K_DEPRECATED void SetViewFrustum(bool pEnable);

	/** Use the GetViewNearFarPlanes */
    K_DEPRECATED bool GetViewFrustum() const;
