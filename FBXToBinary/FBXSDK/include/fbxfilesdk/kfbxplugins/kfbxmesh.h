...
public:
    ...
    /** Insert the DuplicateVertex information in the pSplitList for the points that have to be split
      * depending on pObject value.
      * \param pSplitList The list containing the KDuplicateVertex information of the points that will be split.
      * \param pObject The object of interest of the split.
      * \remarks This function is deprecated and has been replaced with SplitPoints.
      */
    K_DEPRECATED void BuildSplitList(KArrayTemplate<KArrayOfDuplicateVertex* >&pSplitList, ESplitObject pObject);

    /** Split the points specified in the list.
      * \param pSplitList The List containing the information on the points that will be split.
	  * \param pTypeIdentifier
      * \remarks This function allocates memory dynamically. Call DeleteAndClear() with pSplitList to release them.
      * \remarks This function is deprecated and has been replaced with SplitPoints.
      */
    K_DEPRECATED void SplitPointsForHardEdge(KArrayTemplate<KArrayOfDuplicateVertex* > &pSplitList, KFbxLayerElement::ELayerElementType pTypeIdentifier=KFbxLayerElement::eDIFFUSE_TEXTURES);
